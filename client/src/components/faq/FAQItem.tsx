...
export default function FAQItem({ question, answer, isOpen, onClick, style }: FAQItemProps & { style?: any }) {
    ...
    return (
        <div className="w-full" style={{ ...style }}>
            ...
            >
                ...
                <img src={blackPlus} className={`w-5 h-5 transition-transform duration-300 ${isOpen ? "rotate-45" : ""}`} alt={isOpen ? "Collapse" : "Expand"} />
            </div>
